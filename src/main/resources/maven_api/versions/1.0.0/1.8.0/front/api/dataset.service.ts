...
export class DatasetService implements DatasetServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createNewDatasetVersion(datasetId: string, datasetType: DatasetType, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public createNewDatasetVersion(datasetId: string, datasetType: DatasetType, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public createNewDatasetVersion(datasetId: string, datasetType: DatasetType, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public createNewDatasetVersion(datasetId: string, datasetType: DatasetType, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (datasetId === null || datasetId === undefined) {
            throw new Error('Required parameter datasetId was null or undefined when calling createNewDatasetVersion.');
        }
        if (datasetType === null || datasetType === undefined) {
            throw new Error('Required parameter datasetType was null or undefined when calling createNewDatasetVersion.');
        }
        ...
        let localVarPath = `/v1/datasets/${this.configuration.encodeParam({name: "datasetId", value: datasetId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}/newVersion`;
        return this.httpClient.request<any>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
